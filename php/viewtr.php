...
?>
 ...
 <html>
   ...
   <a href="viewtr.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">view tourists</a>
 ...
 echo 
 "<table id='myTable'>
 <h4>LIST OF TOURIST IN THE DATABASE</h4>
 
 <input type='text' id='myInput' onkeyup='myFunction()' placeholder='Search tourist names..' title='Type in a name'>
     <thead>
     <tr class='header'>
     <th></th>
     <th>TouristID</th>
     ...
     <tbody>";
// <a href='update_tr.php'><button>update</button>
   while($row = $result->fetch_assoc()) {
       echo "
       <tr>
       <td><a href='delete_tr.php'>
